...
class NewsListViewModel: NewsListViewModelProtocol {
    ...
    private func setupMockObjects() {
        sections = [
            TableCollectionViewSection(items: [ArticleCellViewModel(article: ArticleResponseObject(title: "First object", description: "First object description in the mock object", urlToImage: "...", date: "17.01.2023"))])
        ]
    }
}
